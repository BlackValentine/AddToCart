        ...
        <header>
            <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default"
                ...
                <li>
                    <ul className="social">
                        <li>
                            <a href="#123" className="icons-sm fb-ic">
                                <i className="fa fa-facebook"> </i>
                            </a>
                        </li>
                        <li>
                            <a href="#123" className="icons-sm pin-ic">
                                <i className="fa fa-pinterest"> </i>
                            </a>
                        </li>
                        <li>
                            <a href="#123" className="icons-sm gplus-ic">
                                <i className="fa fa-google-plus"> </i>
                            </a>
                        </li>
                        <li>
                            <a href="#123" className="icons-sm tw-ic">
                ...
                <li>
                    ...
                    <ul className="collapsible collapsible-accordion">
                        <li>
                            <a href="#123" className="collapsible-header waves-effect arrow-r">
                        ...
                        <li className="active">
                            <a href="#123" className="collapsible-header waves-effect arrow-r active">
            ...
            <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                ...
                <div className="float-left">
                    <a href="#123" data-activates="slide-out" className="button-collapse">
                ...
                <ul className="nav navbar-nav nav-flex-icons ml-auto">
                    <li className="nav-item dropdown">
                        <a href="#123" className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i className="fa fa-user"></i>
                            Tài Khoản
                        </a>
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                            <a href="#123" className="dropdown-item waves-effect waves-light">Đăng Ký</a>
                            <a href="#123" className="dropdown-item waves-effect waves-light">Đăng Nhập</a>
                            <a href="#123" className="dropdown-item waves-effect waves-light">Đăng Xuất</a>
                        </div>
                    </li>
                </ul>
